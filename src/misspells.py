...
typo_string = """abandonned->abandoned
...
typo_list = typo_string.split('\n')
typo_dict = dict([[t.split('->')[0], t.split('->')[-1].split(',')[0]] if len(t.split('->')[-1].split(',')) > 1 else t.split('->') for t in typo_list])

# print(list(typo_dict.items())[:5])
