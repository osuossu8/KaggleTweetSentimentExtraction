...
EXP_ID = "exp49"
import src.configs.config49 as config
import src.engine49 as engine
...
def run_one_fold(fold_id):
    ...
    with timer('load csv data'):
        ...
        special_df = df_train[(df_train['text_equal_selected_text']==0)&(df_train['is_text_start_with_white_space']==0)]
