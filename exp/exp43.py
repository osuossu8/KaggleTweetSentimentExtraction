...
EXP_ID = "exp43"
import src.configs.config43 as config
import src.engine as engine
from src.machine_learning_util import seed_everything, prepare_labels, DownSampler, timer, \
                                      to_pickle, unpickle
from src.model import TweetBERTBaseUncased, TweetModel, TweetModelLargeWWM, TweetRoBERTaModel, TweetBERTModelMK3
...
def run_one_fold(fold_id):
    ...
    with timer('create model'):
        ...
        model = TweetBERTModelMK3(config.BERT_PATH)
