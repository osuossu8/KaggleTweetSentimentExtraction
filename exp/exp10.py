...
import src.configs.config10 as config
import src.engine as engine
from src.machine_learning_util import seed_everything, prepare_labels, DownSampler, timer, \
                                      to_pickle, unpickle
from src.model import TweetBERTBaseUncased, TweetModel, TweetModelLargeWWM, TweetRoBERTaModel
...
# replace dict
# https://www.kaggle.com/doomdiskday/full-tutorial-eda-to-dnns-all-you-need/notebook
# https://www.kaggle.com/c/tweet-sentiment-extraction/discussion/138272
replace_dict = {
    18:'miss',
    27:'no internet',
    49:'I`m not thrilled at all with mine.',
    84:'sorry guys',
    129:'adore',
    134:'nice',
    160:'really bad',
    ...
    245:'ahaha',
    260:'harmed',
    285:'he was soooo friendly.',
    295:'it`s gorgeous out!',
    296:'worried',
    361:'Please Review',
    397:'sorry',
    424:'I just don`t entertain him :/',
    491:'Sorry',
    503:'there wasn`t a chance',
    516:'Tomorrow will be tough!',
    532:'Sorry',
    607:'great.',
    664:'i`m sorry',
    677:'no one will help me',
    701:'ok thank',
    708:'LOL Thanks',
    726:'bestttt',
    736:'I hope Avalina isn`t a dud!',
    750:'sucks',
    756:'He`s amazing',
    803:'Thx',
    808:'much fun',
    870:'not bad',
    911:'really love that!',
    930:'Happy',
    936:'you`re the best',
    949:'disappointing',
    955:'fun,',
    956:'wish I could go too',
    991:'turned me human',
    992:'glad',
    998:'just not lucky, never have been.',
    1056:'so itchy',
    1061:'enjoy',
    # df_train[df_train.sentiment != 'neutral'].iloc[600:650] まで
}
...
def run_one_fold(fold_id):
    ...
    with timer('load csv data'):
        ...
        # cleaning data
        for k, v in tqdm(replace_dict.items()):
            df_train.iloc[k]['selected_text'] = v
    ...
    with timer('create model'):
        ...
        model = TweetRoBERTaModel(conf=model_config)
        ...
        #pretrain_path = 'models/exp7_fold0.pth'
        #model.load_state_dict(torch.load(pretrain_path))
        #LOGGER.info(f'pretrained model (exp7) loaded')
